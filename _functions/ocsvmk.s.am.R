ocsvmk.s.am <- function(sp.name, color.choice, nb=10, save.fig, file.out,do.kmeans=T,thresh=0,preva=50) {
...
# color.choice = color of plot, "brown","heat","rainbow","venette","maxent"
