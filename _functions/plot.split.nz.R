plot.split.nz <- function(sp.name,method.name,color.choice="venette",save.fig=F, exp=F,xlim=NULL,ylim=NULL,pdf=F) {
...
#	title(paste("Prediction for New Zealand",sp.name,method.name,sep=", "))
	if(save.fig) savePlot(paste("NZ_prediction_",sp.name,"_",method.name,"_",p.lab,".png",sep=""), type="png")
