...
load("C:\\MMA on HD\\_database\\worldclim.Rdata")
...
# If using 35 bioclim variables, overwrite worldclim and world but not border
load("C:\\MMA on HD\\_database\\bioclim_35.Rdata")
worldclim <- bioclim
world <- worldclim[,c(2,3)]

#load("C:\\MMA on HD\\_database\\worldclim_temp_prec_alt.Rdata")
