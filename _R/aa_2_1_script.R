...
#  ______            _                                      _        _            _                             
# |  ____|          (_)                                    | |      | |     /\   | |                            
# | |__   _ ____   ___ _ __ ___  _ __  _ __ ___   ___ _ __ | |_ __ _| |    /  \  | |__  ___  ___ _ __   ___ ___ 
# |  __| | '_ \ \ / | | '__/ _ \| '_ \| '_ ` _ \ / _ | '_ \| __/ _` | |   / /\ \ | '_ \/ __|/ _ | '_ \ / __/ _ \
# | |____| | | \ V /| | | | (_) | | | | | | | | |  __| | | | || (_| | |  / ____ \| |_) \__ |  __| | | | (_|  __/
# |________| |_|\_/ |_|_|  \___/|_| _____ ______|\___|_| |_|\__\__,_|_| /_/    \_|_.__/|___/\___|_| |_|\___\___|
# |__   __|                        |_   _|_   _|                                                                
#    | |_   _ _ __   ___   ______    | |   | |                                                                  
#    | | | | | '_ \ / _ \ |______|   | |   | |                                                                  
#    | | |_| | |_) |  __/           _| |_ _| |_                                                                 
#    |_|\__, | .__/ \___|          |_____|_____|                                                                
#        __/ | |                                                                                                
#       |___/|_|                                                                                               
...
species.name <- "aa21"  # Aedes albopicta method 2 replicate 1
...
setwd(paste("C:\\MMA\\",species.name,"\\_dist_data_OCSVM",sep=""))
#import data
aa21data=read.table(paste(species.name,"_data_pres_abs_best.txt",sep=""),header=T) #import 2*2933 abs pres data from aa31 mma output
#creating random 366 presence points out of 2933 presence data for parametrizing AA31
pres=aa21data[(aa21data[,11]==1),] #separate presence points,check number of columns
...
abse=aa21data[(aa21data[,11]==0),] #separate absence points
...
# ------------ #
	...
	setwd(paste("C:\\MMA\\",species.name,"\\_dist_data_OCSVM",sep=""))
	data <- read.table(paste(species.name,"_data_pres_abs_best_2.txt",sep=""), header=TRUE)
...
#--------------------------------------------------------#
#save workspace
save.image(paste("C:\\MMA\\",species.name,"\\aa21_world.RData",sep=""))
#save history
savehistory(file = (paste("C:\\MMA\\",species.name,"\\aa21_world.Rhistory",sep="")))
...
#######################################################################################################################################################################
#save workspace
save.image(paste("C:\\MMA\\",species.name,"\\aa_2_1.RData",sep=""))
#save history
savehistory(file = (paste("C:\\MMA\\",species.name,"\\aa_2_1.Rhistory",sep="")))
